...
> 一份面向现代扩散模型推理的中文静态知识库。覆盖 rectified flow、DiT/MMDiT、文生图、文生视频、系统优化的完整技术栈。12 个页面，零外部依赖，`file://` 协议直接打开。
...
如果你是第一次来，推荐阅读顺序：**01 任务总览** → **03 推理背景** → **04 Rectified Flow** → **05 DiT 架构** → **11 系统优化** → **12 成果说明**。

如果你想运行代码，查看 [12 最终成果说明](12_最终成果说明.md) 中的"如何运行"一节，或阅读顶层 `README.md`。
